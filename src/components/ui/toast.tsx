...
>(({ className, ...props }, ref) => (
  <button
    ...
    toast-close=""
    onClick={(e) => {
        // Имитация закрытия для совместимости
        const parent = e.currentTarget.closest('[data-state="open"]');
        if (parent) {
            // В реальном Radix UI это делается автоматически, здесь мы полагаемся на внешний state
        }
    }}
    {...props}
  >
